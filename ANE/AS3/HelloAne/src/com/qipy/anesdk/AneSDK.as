package com.qipy.anesdk
{
	...
	public class AneSDK extends EventDispatcher
	{
		...
		private static const ANDROID_ID:String = "com.qipy.anesdk.android";
		...
		public static function initSDK(isSimulator:Boolean,anePlatform:String  ):void{
			...
			if(!AneSDK.isSimulator){
				...
				extensionContext.call("aneQipy1","init");
				extensionContext.addEventListener(StatusEvent.STATUS,onStatus);
			}
		}
		
		public static function startRecord(value:String):void
		{
			if(extensionContext)
			{
				extensionContext.call("aneQipy1","startRecord" , value);
			}
		}
		...
		public static function stop():void
		{
			if(extensionContext)
			{
				extensionContext.call("aneQipy1","stop" );
			}
		}
		 ...
		 * 
		 */
		public static function startMe(appName:String ):void
		{
			AneSDK.isSimulator = isSimulator;
			AneSDK.anePlatform = anePlatform;
			...
			if(extensionContext)
			{
				extensionContext.call("startMe",appName);
			}
